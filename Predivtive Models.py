...
data_bicycle = pd.read_csv("C:/Users/Eman Abubakr/Downloads/Centennial/project/Bicycle_Thefts.csv")
...
## Evidence that we need to use a better algorithm which will be found using gridsearch for deliverable 3
## The code below if auxillery for those of you who want to explore the prediction power of logistic regression
# clf.fit(X_train, y_train.values.ravel())
# ypredtrain = clf.predict(X_train)
# print("model score: %.3f" % clf.score(X_test, y_test))
# print(f1_score(y_train, ypredtrain, average=None))
